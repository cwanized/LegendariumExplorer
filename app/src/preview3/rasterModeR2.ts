...
export const R2_RASTER_NODE_WIDTH = 176
export const R2_RASTER_NODE_HEIGHT = 64
export const R2_RASTER_OUTER_PADDING = 24
export const R2_RASTER_ROW_HEIGHT = 194
export const R2_RASTER_COLUMN_SIZE = 220
const NODE_WIDTH = R2_RASTER_NODE_WIDTH
const NODE_HEIGHT = R2_RASTER_NODE_HEIGHT
const OUTER_PADDING = R2_RASTER_OUTER_PADDING
const GENERATION_HEIGHT = R2_RASTER_ROW_HEIGHT
const COLUMN_SIZE = R2_RASTER_COLUMN_SIZE
