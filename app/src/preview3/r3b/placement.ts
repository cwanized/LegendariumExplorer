...
import type { R3BLayoutArtifacts } from './types'
...
export function buildModeR3BLayout(
  ...
  applySingleChildrenToTwoParentMidpoint(placementPlan.families, validation, positionedNodes, spouseAttachedByOwnerId)
